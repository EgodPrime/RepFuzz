import openai
client = openai.OpenAI(base_url="http://192.168.2.29:8022/v1", api_key="yb")
...
def re_generate(prompt, batch_size=1, temperature=1.0, max_length=2048):
    ...
    gen_strs = [choice.text for choice in res.choices]
    return gen_strs
