...
class InspectTarget(Target):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.SYSTEM_MESSAGE = "You are a inspect Fuzzer"
    ...
    def wrap_prompt(self, prompt: str, api_name: str) -> str:
        self.prompt_used['separator'] = f"'''Generate a Python program using the {api_name} API from the inspect library.Provide only a runnable Python program without any explanations or other programming languages.'''"
    ...
    def validate_individual(self, filename) -> Tuple[FResult, str]:
        try:
            ...
            return FResult.TIMED_OUT, "inspect"
