...
class TorchTarget(Target):
    def __init__(self, **kwargs):
        ...
        self.SYSTEM_MESSAGE = "You are a torch Fuzzer"
    ...
    def wrap_prompt(self, prompt: str, api_name: str) -> str:
        self.prompt_used['separator'] = f"'''Generate a Python program using the {api_name} API from the torch library.Provide only a runnable Python program without any explanations or other programming languages.'''"
    ...
    def validate_individual(self, filename) -> Tuple[FResult, str]:
        try:
            ...
            return FResult.TIMED_OUT, "torch"
