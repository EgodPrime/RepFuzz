...
class NltkTarget(Target):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.SYSTEM_MESSAGE = "You are a nltk Fuzzer"
    ...
    def wrap_prompt(self, prompt: str, api_name: str) -> str:
        self.prompt_used['separator'] = f"'''Generate a Python program using the {api_name} API from the nltk library.Provide only a runnable Python program without any explanations or other programming languages.'''"
