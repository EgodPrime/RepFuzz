...
class ReTarget(Target):
    def __init__(self, **kwargs):
        super().__init__(**kwargs)
        self.SYSTEM_MESSAGE = "You are a re Fuzzer"
    ...
    def wrap_prompt(self, prompt: str, api_name: str) -> str:
        self.prompt_used['separator'] = f"'''Generate a Python program using the {api_name} API from the re library.Provide only a runnable Python program without any explanations or other programming languages.'''"
